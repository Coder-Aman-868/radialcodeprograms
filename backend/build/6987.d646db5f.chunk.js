"use strict";(self.webpackChunkradial_code_backend=self.webpackChunkradial_code_backend||[]).push([[6987],{40216:(V,T,t)=>{t.d(T,{S:()=>i});var s=t(92132),c=t(47610),x=t(94061),M=t(48653),b=t(83997),C=t(30893);const W=(0,c.Ay)(x.a)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
